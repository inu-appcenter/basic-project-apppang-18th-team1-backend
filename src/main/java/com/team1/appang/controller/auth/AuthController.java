...
import com.team1.appang.exception.DuplicateEmailException;
import com.team1.appang.exception.DuplicatePhoneNumberException;
...
public class AuthController {
    ...
    public ResponseEntity<?> refresh(
        ...
        }catch (InvalidTokenException | MemberNotFoundException e){
            //실패시 401로 에러 메시지 반환
    ...
    public ResponseEntity<?> signUp(
        ...
        if(bindingResult.hasErrors()){
            ...
            //응답 반환
            return ResponseEntity.badRequest().body(new MessageResponse(errorMessage)); //순서 오류 수정
        }
